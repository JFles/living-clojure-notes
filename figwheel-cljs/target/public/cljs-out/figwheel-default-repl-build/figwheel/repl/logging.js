...
var c_8638 = (new goog.debug.Console());
var G__8637_8639 = c_8638.getFormatter();
goog.object.set(G__8637_8639,"showAbsoluteTime",false);

goog.object.set(G__8637_8639,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_8638);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__8640_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__8640_SHARP_);
