...
var temp__5802__auto__ = cljs.core.deref.call(null,devtools.hints.processed_errors);
...
var file = cljs.core.get.call(null,map__11818__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11818__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11818__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e11817){var _e = e11817;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___11820 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___11820)){
var seen_errors_11821 = temp__5802__auto___11820;
if(cljs.core.truth_(seen_errors_11821.has(self))){
} else {
seen_errors_11821.add(self);

var temp__5804__auto___11822 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___11822)){
var sense_11823 = temp__5804__auto___11822;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_11823)].join(''));
} else {
}
}
} else {
...
var temp__5804__auto__ = devtools.hints.error_object_sense.call(null,error);
