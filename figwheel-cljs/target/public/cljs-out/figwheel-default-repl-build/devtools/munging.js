...
var o9498 = temp__5802__auto__;
var temp__5802__auto____$1 = (o9498["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o9499 = temp__5802__auto____$1;
return (o9499["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9347__auto__ = f;
return (o__9347__auto__["toString"]).call(o__9347__auto__);
} else {
return "";
}
}catch (e9500){var _ = e9500;
return "";
}});
...
try{var o__9347__auto___9502 = t;
(o__9347__auto___9502["cljs$lang$ctorPrWriter"]).call(o__9347__auto___9502,t,writer);
}catch (e9501){var __9503 = e9501;
}
...
var char_code = (function (){var o__9347__auto__ = (new String(char$));
return (o__9347__auto__["charCodeAt"]).call(o__9347__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9347__auto__ = String;
return (o__9347__auto__["fromCharCode"]).call(o__9347__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__9504 = num_code;
switch (G__9504) {
case (1):
return (185);
...
var o__9347__auto__ = String;
return (o__9347__auto__["fromCharCode"]).call(o__9347__auto__,superscript_code);
});
/**
...
var temp__5802__auto__ = cljs.core.second.call(null,cljs.core.re_find.call(null,/function\s(.*?)\{/,fn_source));
if(cljs.core.truth_(temp__5802__auto__)){
var meat = temp__5802__auto__;
var temp__5802__auto____$1 = cljs.core.re_find.call(null,/(.*?)\((.*)\)/,meat);
if(cljs.core.truth_(temp__5802__auto____$1)){
...
}catch (e9506){var _e__9354__auto__ = e9506;
return false;
}})())){
...
var vec__9507 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__9507,(0),null);
...
var or__4126__auto__ = (function (){var temp__5802__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5802__auto__)){
...
var temp__5806__auto__ = goog.object.getValueByKeys(devtools.munging.get_global_scope.call(null),ns_module_name.split("."));
...
var len__4736__auto___9516 = arguments.length;
var i__4737__auto___9517 = (0);
while(true){
if((i__4737__auto___9517 < len__4736__auto___9516)){
args__4742__auto__.push((arguments[i__4737__auto___9517]));

var G__9518 = (i__4737__auto___9517 + (1));
i__4737__auto___9517 = G__9518;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__9512){
var vec__9513 = p__9512;
var ns_detector = cljs.core.nth.call(null,vec__9513,(0),null);
...
var G__9519 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__9520 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__9519;
remaining_tokens = G__9520;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq9510){
var G__9511 = cljs.core.first.call(null,seq9510);
var seq9510__$1 = cljs.core.next.call(null,seq9510);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9511,seq9510__$1);
}));
...
var vec__9524 = cljs.core.split_with.call(null,(function (p1__9523_SHARP_){
return cljs.core.not_EQ_.call(null,p1__9523_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__9524,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__9524,(1),null);
...
var vec__9530 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__9530,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__9530,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__9533 = cljs.core.rest.call(null,remaining_tokens);
var G__9534 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__9533;
name_tokens = G__9534;
continue;
} else {
...
var vec__9537 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__9537,(0),null);
var arity = cljs.core.nth.call(null,vec__9537,(1),null);
var vec__9540 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__9540,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__9540,(1),null);
var vec__9543 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__9543,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__9543,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__9543,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__9543,(3),null);
...
var vec__9549 = result;
var munged_ns = cljs.core.nth.call(null,vec__9549,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__9549,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__9549,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__9549,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__9549,(4),null);
var arity = cljs.core.nth.call(null,vec__9549,(5),null);
...
var temp__5802__auto__ = devtools.munging.parse_fn_source.call(null,fn_source);
if(cljs.core.truth_(temp__5802__auto__)){
var vec__9553 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__9553,(0),null);
var args = cljs.core.nth.call(null,vec__9553,(1),null);
var vec__9556 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__9556,(0),null);
var name = cljs.core.nth.call(null,vec__9556,(1),null);
...
var temp__5802__auto__ = cljs.core.get.call(null,state,prefix);
if(cljs.core.truth_(temp__5802__auto__)){
...
var G__9559 = (arity + (1));
var G__9560 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
var temp__5802__auto__ = devtools.munging.get_fn_variadic_arity.call(null,f);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__9561){
var vec__9562 = p__9561;
var arity = cljs.core.nth.call(null,vec__9562,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__9562,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__9565_SHARP_){
return cljs.core.get.call(null,arities,p1__9565_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__9566_SHARP_){
return cljs.core.drop.call(null,(2),p1__9566_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__9569){
var vec__9570 = p__9569;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__9570,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq9567){
var G__9568 = cljs.core.first.call(null,seq9567);
var seq9567__$1 = cljs.core.next.call(null,seq9567);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9568,seq9567__$1);
}));
...
var G__9576 = arg;
var G__9576__$1 = (((G__9576 instanceof cljs.core.Keyword))?G__9576.fqn:null);
switch (G__9576__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__9578__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__9578__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__9578__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__9578__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__9579 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__9579,(0),null);
var fn_name = cljs.core.nth.call(null,vec__9579,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__9579,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__9579,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__9579,(4),null);
var arity = cljs.core.nth.call(null,vec__9579,(5),null);
...
var o__9347__auto__ = f;
return (o__9347__auto__["getBasis"]).call(o__9347__auto__);
});
/**
...
}catch (e9583){var _e__9354__auto__ = e9583;
...
var G__9584 = (obj[cljs.core.first.call(null,path)]);
var G__9585 = cljs.core.rest.call(null,path);
obj = G__9584;
path = G__9585;
continue;
} else {
...
var temp__5802__auto__ = cljs.core.re_matches.call(null,/(.*)\$$/,key);
if(cljs.core.truth_(temp__5802__auto__)){
var m = temp__5802__auto__;
...
var _STAR_ = (function (accum,p__9586){
var vec__9587 = p__9586;
var bit = cljs.core.nth.call(null,vec__9587,(0),null);
var protocol = cljs.core.nth.call(null,vec__9587,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__9590){
var vec__9591 = p__9590;
var ns = cljs.core.nth.call(null,vec__9591,(0),null);
var name = cljs.core.nth.call(null,vec__9591,(1),null);
var selector = cljs.core.nth.call(null,vec__9591,(2),null);
...
var post_process = (function (p__9595){
var vec__9596 = p__9595;
var munged_name = cljs.core.nth.call(null,vec__9596,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__9596,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__9594_SHARP_){
return (obj[cljs.core.first.call(null,p1__9594_SHARP_)]);
}),sorted_matches);
