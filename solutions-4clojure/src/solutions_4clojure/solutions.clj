...
;; you're running now has finished. It can be hard to follow in the abstract, so
...
(= 256 ((pow 2) 16), ((pow 8) 2))
(= [1 8 27 64] (map (pow 3) [1 2 3 4]))
(= [1 2 4 8 16] (map #((pow %) 2) [0 1 2 3 4]))

;; #90 - Cartesian Product
;;
;; Write a func which calcs the Cartesian product of two sets
;;
;; Uses List Comprehension with `for`
...
;;
;; Write a func which returns the symm diff of 2 sets
;; The symm diff is the set of items belonging to ONE but NOT BOTH of the two sets.


;; #100 - Least Common Multiple
;;
;; Write a func which cals the Least Common Multiple.
;; Your func should accept a variable # of pos ints or ratios.
